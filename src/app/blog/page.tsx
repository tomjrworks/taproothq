...
export const metadata = {
  title: "Blog | Main Loop Systems",
  description: "Practical AI automation insights for small business owners. No jargon, just results.",
};
    ...
    <div className="min-h-screen">
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-forest font-medium text-sm tracking-wide uppercase mb-4">Blog</p>
          ...
          <p className="mt-4 text-lg text-stone max-w-xl">
            No buzzwords. Just real automations that save real time for businesses like yours.
          </p>
